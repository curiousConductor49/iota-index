...
function Navbar() {
    return (
        <ul className="border-b-3 border-red-400 font-sans text-2xl flex items-center gap-10 p-5">
            <li className="mr-auto"><NavLink to="/" className="flex flex-row items-center gap-5"><img src={pink} className="h-[60px] w-[60px]"/><span className="font-sans text-3xl text-border-red-400">Iota Index</span></NavLink></li>
