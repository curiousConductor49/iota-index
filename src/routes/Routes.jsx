...
/* current plan:
- create routes in routes.jsx and export the component
- import browserrouter, routes, and route + routes.jsx into app.jsx
- wrap routes/route in browserrouter inside app
